...
const ko: Catalog = {
  ...
  "nav.device": "기기",
  "nav.activity": "활동",
  "dock.usage.caption": "서비스별 사용 한도",
  "dock.device.caption": "표시·이미지·화면 설정",
  "dock.sync": "지금 동기화",
  "dock.syncing": "동기화 중",
  ...
  "dock.providers.title": "표시할 서비스",
  "dock.providers.empty": "사용할 수 있는 서비스가 없어요",
  "dock.images.title": "서비스 이미지",
  "dock.images.empty": "이미지를 설정할 서비스가 없어요",
  ...
  "dock.device.apply": "적용",
  "dock.device.ping": "기기 응답 확인",
  "dock.device.cycle": "다음 서비스 표시",
...
const en: Catalog = {
  ...
  "dock.usage.caption": "Limits by service",
  "dock.device.caption": "Display, images, and screen",
  "dock.sync": "Sync now",
  ...
  "dock.providers.title": "Services to show",
  "dock.providers.empty": "No services available",
  "dock.images.title": "Service images",
  "dock.images.empty": "No services to set images for",
  ...
  "dock.device.apply": "Apply",
  "dock.device.ping": "Check device response",
  "dock.device.cycle": "Show next service",
