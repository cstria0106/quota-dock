#[path = "../firmware/build_support/bitmap_font_generator.rs"]
...
const FONTS: &[(&str, &str, f32, &str)] = &[
    (
        "Galmuri7",
        "../firmware/assets/fonts/Galmuri7.ttf",
        8.0,
        "generated_font_7.rs",
    ),
    (
        "Galmuri9",
        "../firmware/assets/fonts/Galmuri9.ttf",
        10.0,
        "generated_font_9.rs",
    ),
    (
        "Galmuri11",
        "../firmware/assets/fonts/Galmuri11.ttf",
        12.0,
        "generated_font_11.rs",
    ),
];
const TEXT_SOURCE: &str = "../firmware/src/app/text.rs";
